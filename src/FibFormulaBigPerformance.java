...
public class FibFormulaBigPerformance {
    ...
    static void runFullExperiment(String resultsFileName) {
        ...
        for (int inputSize = MININPUTSIZE; inputSize <= MAXINPUTSIZE; inputSize *= 2) {
            ...
            for (long trial = 0; trial < numberOfTrials; trial++) {
                ...
                BigDecimal FibTest = FibFormulaBig(inputSize);
    ...
    public static BigDecimal FibFormulaBig(int n) {
        ...
        BigDecimal bigSqrt5 = new BigDecimal(Math.sqrt(5));
        BigDecimal result = BigDecimal.valueOf(phi).pow(n).divide(bigSqrt5);
        return result.round(new MathContext(0, RoundingMode.HALF_UP));

        // BigDecimal result = BigDecimal.valueOf(Math.pow(phi,n) / Math.sqrt(5));
        // return result.round(new MathContext(0, RoundingMode.HALF_UP));
    }
}
